...
template<class T>
void cuaternario<T>::imprimir_imagen(){
...
avril->cargar_imagen();
//avril->imprimir_imagen();
avril->add(avril->root);
//yo->print_archivo(yo->root);
avril->print_imagen(avril->root);
avril->imprimir_imagen();
